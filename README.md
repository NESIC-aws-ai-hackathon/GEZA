...
| 問い | 答え |
|------|------|
| **何を作るのか** | やらかした内容を **一言** 入れると、謝罪の深刻度判定 → 相手分析 → 台本全文生成 → タイミング指示まで AI が全自動で出す「謝罪丸投げコンシェルジュ」。さらに、謝罪中のリアルタイム支援（怒り残量スキャナー・GEZA耳打ちモード）、送る前の文面チェック、相手の返信分析、謝罪カルテへの蓄積、謝罪傾向診断まで **謝罪前・謝罪中・謝罪後** を一貫して支援する |
...
| **③** | [stories.md](aidlc-docs/inception/user-stories/stories.md) | 5分 | INVEST済37ストーリー/245SP |
...
| **Unit 分解（開発計画）** | [unit-of-work.md](aidlc-docs/inception/application-design/unit-of-work.md) / [unit-of-work-dependency.md](aidlc-docs/inception/application-design/unit-of-work-dependency.md) | U0〜U9・245SP・依存関係・実装順定義済み |
...
> **将来デバイス想定**: イヤホンやARグラスとの連携により、対面謝罪中にリアルタイムで耳元に助言が届く体験を構想。  
> Inception段階ではユーザー体験・要求として整理し、デバイス連携の具体実装には踏み込まない。
...
INCEPTION PHASE
  ...
  └── 6. Units Generation          → aidlc-docs/inception/application-design/
          ...
          └── unit-of-work-story-map.md （全37ストーリー → ユニット マッピング）
```
