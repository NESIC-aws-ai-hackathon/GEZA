...
> 最終更新: 2026-04-30（コンセプト変更: 総合謝罪支援コンシェルジュ / 謝罪角度機能追加）  
> 生成日: 2026-04-30  
...
GEZAは**総合謝罪支援コンシェルジュ**です。  
謝罪を「成功まで導くプランニング」が主要機能であり、練習シミュレーションはプランの中の任意ステップです。  
キラー機能は**謝罪の角度アセスメント**—やらかしの深刻度をAIが0〜180°の角度で数値化しSVGビジュアルで表示します。
...
```javascript
class ApologyMeter {
  // 角度値（0〜180）を受け取り、SVGイラストをアニメーション付きで更新する
  // degree: 0〜180の角度値
  setDegree(degree)
